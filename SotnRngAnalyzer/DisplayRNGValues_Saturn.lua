...
P.update = function()
    ...
    P.nice_seed = P.read32(P.Addresses.NiceSeed)
    P.evil_seed = P.read32(P.Addresses.EvilSeed)
    P.nice_index = P.seed_index(P.StartingSeeds.NiceSeed, P.nice_seed, P.Tumblers.NiceSeed)
    P.evil_index = P.seed_index(P.StartingSeeds.EvilSeed, P.evil_seed, P.Tumblers.EvilSeed)
end
...
P.canvas.SetTitle("DisplayRNGValues_Saturn")
